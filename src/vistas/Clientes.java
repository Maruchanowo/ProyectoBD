...
public class Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Guardar, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
        ...
        Guardar.getAccessibleContext().setAccessibleName("90");
        Guardar.getAccessibleContext().setAccessibleDescription("20");
        Modificar.getAccessibleContext().setAccessibleName("90");
        Modificar.getAccessibleContext().setAccessibleDescription("20");
        Eliminar.getAccessibleContext().setAccessibleName("90");
        Eliminar.getAccessibleContext().setAccessibleDescription("20");
        jButton1.getAccessibleContext().setAccessibleName("90");
        jButton1.getAccessibleContext().setAccessibleDescription("20");
    ...
    try {
        ...
        while(resul.next()){
            Cliente[0]=resul.getString(1);
              Cliente[1]=resul.getString(2);
                Cliente[2]=resul.getString(3);  
                  Cliente[3]=resul.getString(4);
                   Cliente[4]=resul.getString(5);
    ...
    public void Guardar(){
        ...
        try{
            ...
            ResultSet resultado=set.executeQuery("Select*from Cliente where IdCliente like'"+ID.getText()+"'");
            if(resultado.next()){
                getToolkit().beep();
    ...
    try {
        PreparedStatement pasar=conectar.prepareStatement("Update Cliente set Nombre='"+txtNombre.getText()+"',FechaDeNacimiento='"+txtFecha.getText()+"',Direccion='"+txtDireccion.getText()
                +"',Celular='"+txtCelular.getText()+"' where IdCliente='"+ID.getText()+"'");
        pasar.executeUpdate();
        Mostrar("");
    ...
    try {
        PreparedStatement borrar=conectar.prepareStatement("Delete from Cliente where IdCliente='"+ID+"'");
