...
Connection conectar=conect.Conectar();
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtStock, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(Eliminar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE))
    ...
    public void Guardar(){
        String Id=ID.getText(),Nombre=txtNombre.getText(),Marca=txtMarca.getText(),Stock=txtStock.getText(),
                Precio=txtPrecio.getText();
        String Sql="Insert into Productos() Values(?,?,?,?,?)";
        try{
            Statement set=(Statement)conectar.createStatement();
            ResultSet resultado=set.executeQuery("Select*from Productos where IdProductos like'"+ID.getText()+"'");
            if(resultado.next()){
                getToolkit().beep();
                ...
                pasar.setString(4, Stock);
                pasar.setString(5, Precio);
                pasar.executeUpdate();
         ...
         ID.setText(jTable1.getValueAt(fila,0).toString());
          txtNombre.setText(jTable1.getValueAt(fila,1).toString());
           txtMarca.setText(jTable1.getValueAt(fila,2).toString());
            txtStock.setText(jTable1.getValueAt(fila,3).toString());
             txtPrecio.setText(jTable1.getValueAt(fila,4).toString());
     }else{
    ...
    try {
        PreparedStatement pasar=conectar.prepareStatement("Update Productos set Nombre='"+txtNombre.getText()+"',Marca='"+txtMarca.getText()+"',Stock='"+txtStock.getText()
                +"',Precio='"+txtPrecio.getText()+"' where IdProductos='"+ID.getText()+"'");
        pasar.executeUpdate();
        Mostrar("");
    ...
    try {
        PreparedStatement borrar=conectar.prepareStatement("Delete from Productos where IdProductos='"+ID+"'");
